...
export const eventAttributes = (
 ...
 options?: SecondParameter<typeof customFetch>,signal?: AbortSignal
      ...
      {url: `/api/external/modules/exploration/v1/${ocelId}/events/attributes`, method: 'GET',
        params, signal
    },
      options);
    }
...
export const getEventAttributesQueryKey = (ocelId: string | null,
    params?: EventAttributesParams,) => {
    return [
    `/api/external/modules/exploration/v1/${ocelId}/events/attributes`, ...(params ? [params] : [])
    ] as const;
    }
...
export const eventAttributeHistogram = (
 ...
 options?: SecondParameter<typeof customFetch>,signal?: AbortSignal
      ...
      {url: `/api/external/modules/exploration/v1/${ocelId}/events/${eventType}/${attribute}/histogram`, method: 'POST',
...
export const getEventAttributeHistogramQueryKey = (ocelId: string | null,
    ...
    params?: EventAttributeHistogramParams,) => {
    return [
    `/api/external/modules/exploration/v1/${ocelId}/events/${eventType}/${attribute}/histogram`, ...(params ? [params] : []), histogramBody
    ] as const;
    }
...
export const eventAttributeInstances = (
 ...
 options?: SecondParameter<typeof customFetch>,signal?: AbortSignal
      ...
      {url: `/api/external/modules/exploration/v1/${ocelId}/events/${eventType}/${attribute}/instances`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
...
export const getEventAttributeInstancesQueryKey = (ocelId: string | null,
    ...
    params?: EventAttributeInstancesParams,) => {
    return [
    `/api/external/modules/exploration/v1/${ocelId}/events/${eventType}/${attribute}/instances`, ...(params ? [params] : []), eventInstancesBody
    ] as const;
    }
